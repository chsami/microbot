...
import net.runelite.client.plugins.microbot.playerassistfork.enums.PlayStyle;
import net.runelite.client.plugins.microbot.playerassistfork.enums.PrayerStyle;

@ConfigGroup(net.runelite.client.plugins.microbot.playerassistfork.PlayerAssistConfig.GROUP)
