...
import net.runelite.client.plugins.hoseaplugins.lucidhotkeys.LocalRegionTile;
import net.runelite.client.plugins.hoseaplugins.lucidhotkeys.LucidHotkeysConfig;
import net.runelite.client.plugins.hoseaplugins.lucidhotkeys.LucidHotkeysPlugin;
