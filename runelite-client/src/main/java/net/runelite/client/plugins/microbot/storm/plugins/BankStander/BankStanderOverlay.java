    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(LineComponent.builder()
                    ...
                    .build());
            panelComponent.getChildren().add(LineComponent.builder()
                    .left("Item 1 : " + BankStanderScript.firstIdentity)
                    .leftColor(PluginDescriptor.stormColor)
                    .build());
            panelComponent.getChildren().add(LineComponent.builder()
                    .left("Item 2 : " + BankStanderScript.secondIdentity)
                    .leftColor(PluginDescriptor.stormColor)
                    .build());
            if(BankStanderScript.fourItems){
                panelComponent.getChildren().add(LineComponent.builder()
                        .left("Item 3 : " + BankStanderScript.thirdIdentity)
                        .leftColor(PluginDescriptor.stormColor)
                        .build());
                panelComponent.getChildren().add(LineComponent.builder()
                        .left("Item 4 : " + BankStanderScript.fourthIdentity)
                        .leftColor(PluginDescriptor.stormColor)
                        .build()); }
