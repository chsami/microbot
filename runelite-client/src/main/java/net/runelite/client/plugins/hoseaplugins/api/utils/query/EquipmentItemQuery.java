package net.runelite.client.plugins.hoseaplugins.api.utils.query;

import net.runelite.api.widgets.Widget;
import net.runelite.client.util.Text;
import net.runelite.client.util.WildcardMatcher;
import net.runelite.client.plugins.hoseaplugins.api.utils.query.EquipmentItemQuery;
import net.runelite.client.plugins.hoseaplugins.api.utils.EquipmentItemWidget;
import java.util.*;
