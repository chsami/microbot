...
public class Rs2Inventory {
    ...
    public static boolean isInventoryFull() {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).filter(Rs2Inventory::itemExistsInInventory).count() == 28);
    }
    ...
    public static long count() {
        ...
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).filter(Rs2Inventory::itemExistsInInventory).count());
    }
    ...
    public static int getItemAmount(int id) {
        ...
        Widget item = Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).filter(x -> itemExistsInInventory(x) && x.getItemId() == id).findFirst().orElse(null));

        if (item != null) return item.getItemQuantity();
    ...
    public static boolean isInventoryFull(String itemName) {
        return Microbot.getClientThread().runOnClientThread(() -> {
            ...
            return Arrays.stream(inventoryWidget.getDynamicChildren()).filter(Rs2Inventory::itemExistsInInventory).count() == 28;
        });
    }
    ...
    public static boolean hasAmountInventoryItems(int count) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).filter(Rs2Inventory::itemExistsInInventory).count() == count);
    }
    ...
    public static boolean hasItemStackable(String itemName) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Arrays.stream(inventoryWidget.getDynamicChildren()).anyMatch(x -> {
    ...
    public static boolean hasItem(String itemName) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).anyMatch(x -> itemExistsInInventory(x) && x.getName().split(">")[1].split("</")[0].equalsIgnoreCase(itemName)));
    }
    ...
    public static boolean hasItem(int id) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).anyMatch(x -> itemExistsInInventory(x) && x.getItemId() == id));
    }
    ...
    public static boolean hasItemContains(String itemName) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).anyMatch(x -> itemExistsInInventory(x) && x.getName().split(">")[1].split("</")[0].toLowerCase().contains(itemName.toLowerCase())));
    }
    ...
    public static Widget[] getInventoryItems() {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return null;
        return Arrays.stream(inventoryWidget.getDynamicChildren()).filter(Rs2Inventory::itemExistsInInventory).toArray(Widget[]::new);
    }
    ...
    public static boolean hasItemAmount(int itemId, int amount) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).filter(x -> itemExistsInInventory(x) && x.getItemId() == itemId).count() >= amount);
    }
    ...
    public static boolean hasItemAmount(String itemName, int amount) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).filter(x -> itemExistsInInventory(x) && x.getName().split(">")[1].split("</")[0].equalsIgnoreCase(itemName)).count() >= amount);
    }
    ...
    public static boolean hasItemAmountStackable(String itemName, int amount) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return false;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).anyMatch(x -> itemExistsInInventory(x) && x.getName().split(">")[1].split("</")[0].equalsIgnoreCase(itemName) && x.getItemQuantity() >= amount));
    }
    ...
    public static boolean useItemSafe(String itemName) {
        ...
        Tab.switchToInventoryTab();
        if (isUsingItem()) Microbot.getMouse().click();
    ...
    public static boolean drop(String itemName) {
        if (!Rs2Settings.enableDropShiftSetting()) return false;
        if (Rs2Inventory.isEmpty()) return true;
        if (!VirtualKeyboard.isKeyPressed(KeyEvent.VK_SHIFT) || !Rs2Menu.hasAction("drop")) VirtualKeyboard.holdShift();
    ...
    public static long getAmountForItem(String itemName) {
        ...
        Widget inventoryWidget = getInventory();
        if (inventoryWidget == null) return 0;
        return Microbot.getClientThread().runOnClientThread(() -> Arrays.stream(inventoryWidget.getDynamicChildren()).filter(x -> itemExistsInInventory(x) && x.getName().split(">")[1].split("</")[0].toLowerCase().contains(itemName.toLowerCase())).count());
    }
    ...
    public static void handleMenuSwapper(MenuEntry menuEntry) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
        ...
        try {
            ...
            } else if (itemAction.equalsIgnoreCase("drink") || itemAction.equalsIgnoreCase("read") || itemAction.equalsIgnoreCase("eat") || itemAction.equalsIgnoreCase("view") || itemAction.equalsIgnoreCase("bury")) {
                index = 2;
                menuEntry.setType(MenuAction.CC_OP);
            } else if (itemAction.equalsIgnoreCase("wield") || itemAction.equalsIgnoreCase("wear") || itemAction.equalsIgnoreCase("check steps")) {
                index = 3;
                menuEntry.setType(MenuAction.CC_OP);
            } else if (itemAction.equalsIgnoreCase("fill")) {
                index = 4;
                menuEntry.setType(MenuAction.CC_OP);
            } else if (itemAction.equalsIgnoreCase("empty") || itemAction.equalsIgnoreCase("rub") || itemAction.equalsIgnoreCase("refund") || itemAction.equalsIgnoreCase("commune") || itemAction.equalsIgnoreCase("extinguish")) {
                index = 6;
                menuEntry.setType(MenuAction.CC_OP);
    ...
    public static Widget findItemInMemory(String itemName, boolean exact) {
        Microbot.status = "Searching inventory for item: " + itemName;
        Tab.switchToInventoryTab();
        return inventoryItems.stream().filter(x -> exact ? x.getName().equalsIgnoreCase(itemName) : x.getName().toLowerCase().contains(itemName.toLowerCase())).findFirst().orElse(null);
    }
