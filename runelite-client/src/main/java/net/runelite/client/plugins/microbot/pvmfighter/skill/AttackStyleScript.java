...
public class AttackStyleScript extends Script {
    ...
    private void changeAttackStyle(PvmFighterConfig config, WidgetInfo attackStyleWidgetInfo) {
    ...
    private WidgetInfo getComponentToDisplay(PvmFighterConfig config) {
