...
public interface QoLConfig extends Config {
    ...
    @ConfigItem(
            keyName = "displaySetup5",
            name = "Setup 5",
            description = "Display Setup 5",
            position = 9,
            section = inventorySection
    )
    default boolean displaySetup5() {
        return false;
    }
    ...
    default String Setup5() {
        return "";
    }

    // boolean to display Setup 6
    @ConfigItem(
            keyName = "displaySetup6",
            name = "Setup 6",
            description = "Display Setup 6",
            position = 11,
            section = inventorySection
    )
    default boolean displaySetup6() {
        return false;
    }
    ...
    default String Setup6() {
        return "";
    }

    // boolean to display Setup 7
    @ConfigItem(
            keyName = "displaySetup7",
            name = "Setup 7",
            description = "Display Setup 7",
            position = 13,
            section = inventorySection
    )
    default boolean displaySetup7() {
        return false;
    }
    ...
    default String Setup7() {
        return "";
    }

    // boolean to display Setup 8
    @ConfigItem(
            keyName = "displaySetup8",
            name = "Setup 8",
            description = "Display Setup 8",
            position = 15,
            section = inventorySection
    )
    default boolean displaySetup8() {
        return false;
    }
    ...
    default String Setup8() {
        return "";
    }

    // boolean to display Setup 9
    @ConfigItem(
            keyName = "displaySetup9",
            name = "Setup 9",
            description = "Display Setup 9",
            position = 17,
            section = inventorySection
    )
    default boolean displaySetup9() {
        return false;
    }
    ...
    default String Setup9() {
        return "";
    }

    // boolean to display Setup 10
    @ConfigItem(
            keyName = "displaySetup10",
            name = "Setup 10",
            description = "Display Setup 10",
            position = 19,
            section = inventorySection
    )
    default boolean displaySetup10() {
        return false;
    }
    ...
    @ConfigItem(
            keyName = "Setup10",
            name = "Name:",
            description = "Setup 10",
            position = 20,
            section = inventorySection
    )
    default String Setup10() {
        return "";
    }

    // boolean to display Setup 11
    @ConfigItem(
            keyName = "displaySetup11",
            name = "Setup 11",
            description = "Display Setup 11",
            position = 21,
            section = inventorySection
    )
    default boolean displaySetup11() {
        return false;
    }
    ...
    @ConfigItem(
            keyName = "Setup11",
            name = "Name:",
            description = "Setup 11",
            position = 22,
            section = inventorySection
    )
    default String Setup11() {
        return "";
    }

    // boolean to display Setup 12
    @ConfigItem(
            keyName = "displaySetup12",
            name = "Setup 12",
            description = "Display Setup 12",
            position = 23,
            section = inventorySection
    )
    default boolean displaySetup12() {
        return false;
    }
    ...
    @ConfigItem(
            keyName = "Setup12",
            name = "Name:",
            description = "Setup 12",
            position = 24,
            section = inventorySection
    )
    default String Setup12() {
        return "";
    }

    // boolean to display Setup 13
    @ConfigItem(
            keyName = "displaySetup13",
            name = "Setup 13",
            description = "Display Setup 13",
            position = 25,
            section = inventorySection
    )
    default boolean displaySetup13() {
        return false;
    }
    ...
    @ConfigItem(
            keyName = "Setup13",
            name = "Name:",
            description = "Setup 13",
            position = 26,
            section = inventorySection
    )
    default String Setup13() {
        return "";
    }

    // boolean to display Setup 14
    @ConfigItem(
            keyName = "displaySetup14",
            name = "Setup 14",
            description = "Display Setup 14",
            position = 27,
            section = inventorySection
    )
    default boolean displaySetup14() {
        return false;
    }
    ...
    @ConfigItem(
            keyName = "Setup14",
            name = "Name:",
            description = "Setup 14",
            position = 28,
            section = inventorySection
    )
    default String Setup14() {
        return "";
    }

    // boolean to display Setup 15
    @ConfigItem(
            keyName = "displaySetup15",
            name = "Setup 15",
            description = "Display Setup 15",
            position = 29,
            section = inventorySection
    )
    default boolean displaySetup15() {
        return false;
    }
    ...
    @ConfigItem(
            keyName = "Setup15",
            name = "Name:",
            description = "Setup 15",
            position = 30,
            section = inventorySection
    )
    default String Setup15() {
        return "";
    }
