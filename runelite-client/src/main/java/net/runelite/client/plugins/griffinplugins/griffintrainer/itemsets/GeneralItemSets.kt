...
class GeneralItemSets {
    ...
    companion object {
        ...
        fun getHelmetItemSet(): DynamicItemSet {
            ...
            if (defenceLevel >= 1) {
                helmets.add(ItemID.BRONZE_MED_HELM, 1)
                helmets.add(ItemID.BRONZE_FULL_HELM, 1)
                helmets.add(ItemID.IRON_MED_HELM, 1)
                helmets.add(ItemID.IRON_FULL_HELM, 1)
            }
            if (defenceLevel >= 5) {
                helmets.add(ItemID.STEEL_MED_HELM, 1)
                helmets.add(ItemID.STEEL_FULL_HELM, 1)
            }
            if (defenceLevel >= 10) {
                helmets.add(ItemID.BLACK_MED_HELM, 1)
                helmets.add(ItemID.BLACK_FULL_HELM, 1)
            }
            if (defenceLevel >= 20) {
                helmets.add(ItemID.MITHRIL_MED_HELM, 1)
                helmets.add(ItemID.MITHRIL_FULL_HELM, 1)
            }
            if (defenceLevel >= 30) {
                helmets.add(ItemID.ADAMANT_MED_HELM, 1)
                helmets.add(ItemID.ADAMANT_FULL_HELM, 1)
            }
            if (defenceLevel >= 40) {
                helmets.add(ItemID.RUNE_MED_HELM, 1)
                helmets.add(ItemID.RUNE_FULL_HELM, 1)
            }
        ...
        fun getBodiesItemSet(): DynamicItemSet {
            ...
            if (defenceLevel >= 1) {
                bodies.add(ItemID.BRONZE_CHAINBODY, 1)
                bodies.add(ItemID.BRONZE_PLATEBODY, 1)
                bodies.add(ItemID.IRON_CHAINBODY, 1)
                bodies.add(ItemID.IRON_PLATEBODY, 1)
            }
            if (defenceLevel >= 5) {
                bodies.add(ItemID.STEEL_CHAINBODY, 1)
                bodies.add(ItemID.STEEL_PLATEBODY, 1)
            }
            if (defenceLevel >= 10) {
                bodies.add(ItemID.BLACK_CHAINBODY, 1)
                bodies.add(ItemID.BLACK_PLATEBODY, 1)
            }
            if (defenceLevel >= 20) {
                bodies.add(ItemID.MITHRIL_CHAINBODY, 1)
                bodies.add(ItemID.MITHRIL_PLATEBODY, 1)
            }
            if (defenceLevel >= 30) {
                bodies.add(ItemID.ADAMANT_CHAINBODY, 1)
                bodies.add(ItemID.ADAMANT_PLATEBODY, 1)
            }
            if (defenceLevel >= 40) {
                bodies.add(ItemID.RUNE_CHAINBODY, 1)
                bodies.add(ItemID.RUNE_PLATEBODY, 1)
            }
        ...
        fun getLegsItemSet(): DynamicItemSet {
            ...
            if (defenceLevel >= 1) {
                legs.add(ItemID.BRONZE_PLATESKIRT, 1)
                legs.add(ItemID.BRONZE_PLATELEGS, 1)
                legs.add(ItemID.IRON_PLATESKIRT, 1)
                legs.add(ItemID.IRON_PLATELEGS, 1)
            }
            if (defenceLevel >= 5) {
                legs.add(ItemID.STEEL_PLATESKIRT, 1)
                legs.add(ItemID.STEEL_PLATELEGS, 1)
            }
            if (defenceLevel >= 10) {
                legs.add(ItemID.BLACK_PLATESKIRT, 1)
                legs.add(ItemID.BLACK_PLATELEGS, 1)
            }
            if (defenceLevel >= 20) {
                legs.add(ItemID.MITHRIL_PLATESKIRT, 1)
                legs.add(ItemID.MITHRIL_PLATELEGS, 1)
            }
            if (defenceLevel >= 30) {
                legs.add(ItemID.ADAMANT_PLATESKIRT, 1)
                legs.add(ItemID.ADAMANT_PLATELEGS, 1)
            }
            if (defenceLevel >= 40) {
                legs.add(ItemID.RUNE_PLATESKIRT, 1)
                legs.add(ItemID.RUNE_PLATELEGS, 1)
            }
        ...
        fun getBootsItemSet(): DynamicItemSet {
            ...
            if (defenceLevel >= 1) {
                boots.add(ItemID.BRONZE_BOOTS, 1)
                boots.add(ItemID.IRON_BOOTS, 1)
            }
            if (defenceLevel >= 5) {
                boots.add(ItemID.STEEL_BOOTS, 1)
            }
            if (defenceLevel >= 10) {
                boots.add(ItemID.BLACK_BOOTS, 1)
            }
            if (defenceLevel >= 20) {
                boots.add(ItemID.MITHRIL_BOOTS, 1)
            }
            if (defenceLevel >= 30) {
                boots.add(ItemID.ADAMANT_BOOTS, 1)
            }
            if (defenceLevel >= 40) {
                boots.add(ItemID.RUNE_BOOTS, 1)
            }
        ...
        fun getShieldsItemSet(): DynamicItemSet {
            ...
            if (defenceLevel >= 1) {
                ...
                shields.add(ItemID.BRONZE_SQ_SHIELD, 1)
                shields.add(ItemID.BRONZE_KITESHIELD, 1)
                shields.add(ItemID.IRON_SQ_SHIELD, 1)
                shields.add(ItemID.IRON_KITESHIELD, 1)
            }
            if (defenceLevel >= 5) {
                shields.add(ItemID.STEEL_SQ_SHIELD, 1)
                shields.add(ItemID.STEEL_KITESHIELD, 1)
            }
            if (defenceLevel >= 10) {
                shields.add(ItemID.BLACK_SQ_SHIELD, 1)
                shields.add(ItemID.BLACK_KITESHIELD, 1)
            }
            if (defenceLevel >= 20) {
                shields.add(ItemID.MITHRIL_SQ_SHIELD, 1)
                shields.add(ItemID.MITHRIL_KITESHIELD, 1)
            }
            if (defenceLevel >= 30) {
                shields.add(ItemID.ADAMANT_SQ_SHIELD, 1)
                shields.add(ItemID.ADAMANT_KITESHIELD, 1)
            }
            if (defenceLevel >= 40) {
                shields.add(ItemID.RUNE_SQ_SHIELD, 1)
                shields.add(ItemID.RUNE_KITESHIELD, 1)
            }
