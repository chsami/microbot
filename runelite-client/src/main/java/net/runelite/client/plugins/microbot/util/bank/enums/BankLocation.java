...
public enum BankLocation {
    ...
    LUMBRIDGE_CASTLE_TOP(new WorldPoint(3209, 3219, 2)),
    EDGEVILLE_BANK( new WorldPoint(3093, 3492, 0)),
    ...
    LUMBRIDGE_TOP(new WorldPoint(3208, 3220, 2)),
