...
public class AirOrbScript extends Script {
    ...
    private final Pattern gloryPattern = Pattern.compile(gloryRegex);
            ...
            try {
                ...
                switch(state) {
                    case BANKING:
                        ...
                        if (Rs2Equipment.hasEquipped(ItemID.AMULET_OF_GLORY)) {
                            Rs2Item amuletOfGlory = Rs2Bank.bankItems()
                                    .stream()
                                    .filter(item -> gloryPattern.matcher(item.name).matches())
                                    .findFirst()
                                    .orElse(null);
                        ...
                        } else if (!Rs2Equipment.hasEquippedSlot(EquipmentInventorySlot.AMULET) || !gloryPattern.matcher(Rs2Equipment.get(EquipmentInventorySlot.AMULET).getName()).matches()) {
                            Rs2Item amuletOfGlory = Rs2Bank.bankItems()
                                    .stream()
                                    .filter(item -> gloryPattern.matcher(item.name).matches())
                                    .findFirst()
                        ...
                        int unpoweredOrbAmount = Rs2Inventory.getEmptySlots() - 1;
    ...
    private boolean hasRequiredItems() {
        return Rs2Inventory.hasItemAmount(ItemID.COSMIC_RUNE, 75) && Rs2Inventory.hasItemAmount(ItemID.UNPOWERED_ORB, 25);
    }
